                ...
                <div className="justify-between items-center flex">
                  <div className="w-fit rounded-full mr-3 relative">
                    ...
                    <AvatarUploader
                      ...
                      circle
                    />
                    {/* Online status indicator (kept from your version) */}
              ...
              <div className="h-full flex-col flex">
                <div className="px-4 space-y-4">
                  <nav className="bg-top bg-cover space-y-1">
                    <a
                      href="#"
                      className="font-medium text-sm items-center rounded-lg text-gray-900 px-4 py-2.5 block flex transition-all duration-200 hover:bg-gray-200 group cursor-pointer"
                    >
                      <svg
                    ...
                    >
                      ...
                      <span>Messages</span>
                      <span className="px-2 py-0.5 items-center font-semibold text-xs ml-auto bg-red-600 text-white rounded-full uppercase border border-transparent inline-flex">
                        15
                      </span>
                    </a>
                    ...
                    >
                      ...
                      >
                        <path
                          fill="#000000"
                          d="m10.555 1.764l1.715.572a3.7 3.7 0 0 1 2.53 3.51V8.3h3.869a3 3 0 0 1 2.965 3.456l-1.185 7.7A3 3 0 0 1 17.484 22H2V10.1h4.85l3.705-8.336ZM6.5 12.1H4V20h2.5v-7.9Zm2 7.9h8.984a1 1 0 0 0 .988-.848l1.185-7.7a1 1 0 0 0-.988-1.152H12.8V5.846a1.7 1.7 0 0 0-1.155-1.61L8.5 11.312V20Z"
                        ></path>
                      </svg>
                      <span>Reviews</span>
                    </a>
                  ...
                  <nav className="bg-top bg-cover">
                    ...
                    >
                      ...
                      >
                        <path
                          fill="#000000"
                          d="M16.07 8H15V5s0-5-5-5s-5 5-5 5v3H3.93A1.93 1.93 0 0 0 2 9.93v8.15A1.93 1.93 0 0 0 3.93 20h12.14A1.93 1.93 0 0 0 18 18.07V9.93A1.93 1.93 0 0 0 16.07 8zM10 16a2 2 0 1 1 2-2a2 2 0 0 1-2 2zm3-8H7V5.5C7 4 7 2 10 2s3 2 3 3.5z"
                        ></path>
                      </svg>
                      <span>Logout</span>
                    </a>
